...
%
%=====This code has been taken from Coursera=====
%=========Credit goes to the respective developers not me=======
...
croppedImage = Image2DmatrixBW(cropOrigin(1):copySize(1) ...
			,cropOrigin(2):copySize(2));
